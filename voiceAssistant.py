...
def reply(text):
    ...
    # To search something on wikipedia
        ...
        choice = listen()
        if choice == "numberguess" or choice == "number":
            numberguess.game()
        else:
            blackjack.game()
    elif "password" and "manager" in text:
        password.password_manager()
    elif "search" and "google" in text:
        talk("Enter what do you want to search")
        text = input("Enter what do you want to search:")
        search(text)
    else:
...
# ytube           hemant done
# call            
# change voice    hemant done
# games           mohit done
# alarm           
#password manager mohit done
# numberguess.game()
